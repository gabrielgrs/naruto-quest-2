...
export default (state = INITIAL_STATE, action) => {
  switch (action.type) {
    ...
    case actionTypes.GET_ALL.SUCCESS:
      return { ...state, jobsList: action.payload, loadingJob: false }
    case actionTypes.GET_ALL.FAIL:
      return { ...state, error: action.payload, loadingJob: false }
    case actionTypes.GET_BY_ID.BASE:
      return { ...state, loadingJob: true }
    case actionTypes.GET_BY_ID.SUCCESS:
      return { ...state, selected: action.payload, loadingJob: false }
