...
export default (state = INITIAL_STATE, action) => {
  switch (action.type) {
    case actionTypes.GET_ALL.BASE:
      return { ...state, loadingEnemy: true }
    case actionTypes.GET_ALL.SUCCESS:
      return { ...state, list: action.payload, loadingEnemy: false }
    case actionTypes.GET_ALL.FAIL:
      return { ...state, error: action.payload, loadingEnemy: false }
    case actionTypes.GET_BY_ID.BASE:
      return { ...state, loadingEnemy: true }
    case actionTypes.GET_BY_ID.SUCCESS:
      return { ...state, selected: action.payload, loadingEnemy: false }
